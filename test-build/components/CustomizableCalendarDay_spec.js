...
var _CustomizableCalendarDay = _interopRequireWildcard(require("../../lib/components/CustomizableCalendarDay"));
...
describe('CustomizableCalendarDay', function () {
  afterEach(function () {
  ...
  describe('#render', function () {
    it('contains formatted day for single digit days', function () {
      ...
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_CustomizableCalendarDay["default"], {
        day: firstOfMonth
      })).dive();
    ...
    it('passes modifiers to renderDay', function () {
      var modifiers = new Set([_constants.BLOCKED_MODIFIER]);
      var renderDay = function renderDay(day, mods) {
    ...
    it('has button role', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_CustomizableCalendarDay["default"], null)).dive();
    ...
    describe('event handlers', function () {
      ...
      var wrapper;
      beforeEach(function () {
        wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_CustomizableCalendarDay["default"], {
          day: day,
          ariaLabelFormat: "MMMM Do YYYY"
        })).dive();
      });
  ...
  describe('#onDayClick', function () {
    var onDayClickSpy;
    beforeEach(function () {
      onDayClickSpy = _sinonSandbox["default"].spy(_CustomizableCalendarDay.PureCustomizableCalendarDay.prototype, 'onDayClick');
    });
  ...
  describe('#onDayMouseEnter', function () {
    ...
    beforeEach(function () {
      onDayMouseEnterSpy = _sinonSandbox["default"].spy(_CustomizableCalendarDay.PureCustomizableCalendarDay.prototype, 'onDayMouseEnter');
    });
    ...
    it('sets state.isHovered to false', function () {
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_CustomizableCalendarDay["default"], null)).dive();
      wrapper.setState({
        isHovered: false
      });
      wrapper.instance().onDayMouseEnter();
      (0, _chai.expect)(wrapper.state().isHovered).to.equal(true);
    });
  ...
  describe('#onDayMouseLeave', function () {
    ...
    beforeEach(function () {
      onDayMouseLeaveSpy = _sinonSandbox["default"].spy(_CustomizableCalendarDay.PureCustomizableCalendarDay.prototype, 'onDayMouseLeave');
    });
    ...
    it('sets state.isHovered to false', function () {
      ...
      (0, _chai.expect)(wrapper.state().isHovered).to.equal(false);
    });
