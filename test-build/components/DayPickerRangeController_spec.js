        ...
        describe('new startDate exists', function () {
          describe('new focusedInput !== END_DATE', function () {
            ...
            it('updates state to remove `blocked-minimum-nights` and `blocked` from the appropriate days', function () {
              ...
              for (var _i = 0; _i < minimumNights; _i += 1) {
                var _monthString = (0, _toISOMonthString4["default"])(day);
                var _dateString = (0, _toISODateString["default"])(day);
                (0, _chai.expect)(newVisibleDays[_monthString][_dateString]).not.to.include('blocked-minimum-nights');
                (0, _chai.expect)(newVisibleDays[_monthString][_dateString]).not.to.include('blocked');
                day.add(1, 'day');
              }
            });
          });
